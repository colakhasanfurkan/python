...
back = pygame.image.load('/mnt/4f368abd-b8a1-4c9f-ba7b-ca132df1b8d8/python/space/data/back.png').convert_alpha()
ufo = pygame.image.load('/mnt/4f368abd-b8a1-4c9f-ba7b-ca132df1b8d8/python/space/data/ufo.png').convert_alpha()
pygame.display.set_icon(ufo)

bg_music = pygame.mixer.Sound('/mnt/4f368abd-b8a1-4c9f-ba7b-ca132df1b8d8/python/space/data/background.wav')
...
#texts
big_font = pygame.font.Font('/mnt/4f368abd-b8a1-4c9f-ba7b-ca132df1b8d8/python/space/data/Pixeltype.ttf',75)
mid_font = pygame.font.Font('/mnt/4f368abd-b8a1-4c9f-ba7b-ca132df1b8d8/python/space/data/Pixeltype.ttf',50)
small_font = pygame.font.Font('/mnt/4f368abd-b8a1-4c9f-ba7b-ca132df1b8d8/python/space/data/Pixeltype.ttf',25)

#Enemy
enemy_x = [0,0,0,0,0,0,0]
enemy_y = [0,0,0,0,0,0,0]
enemy_rect = [0,0,0,0,0,0,0]
enemy_surface = pygame.image.load('/mnt/4f368abd-b8a1-4c9f-ba7b-ca132df1b8d8/python/space/data/enemy.png').convert_alpha()
...
#ufo/player    
ufo_surface = pygame.image.load('/mnt/4f368abd-b8a1-4c9f-ba7b-ca132df1b8d8/python/space/data/ufo.png').convert_alpha()
ufo_rect = ufo_surface.get_rect(center = (400,500))
ufo_x=ufo_rect.x
ufo_y=ufo_rect.y    
ball_surface = pygame.image.load('/mnt/4f368abd-b8a1-4c9f-ba7b-ca132df1b8d8/python/space/data/ball.png').convert_alpha()
...
while True:
    ...
    if lives > 0:
        ...
        for i in range(7):
            if ufo_rect.colliderect(enemy_rect[i]):
                exp = pygame.mixer.Sound('/mnt/4f368abd-b8a1-4c9f-ba7b-ca132df1b8d8/python/space/data/bang.wav')
                exp.play()
                enemy_x[i] = randint(25,775)
    ...
    if lives == 0:
        ...
        while over_s==0:
            over = pygame.mixer.Sound('/mnt/4f368abd-b8a1-4c9f-ba7b-ca132df1b8d8/python/space/data/over.wav')
            over.play()
            over_s +=1
